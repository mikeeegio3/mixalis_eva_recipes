          ...
          <div class="container-fluid ml-4 rounded syntages-midsection p-4">
            ...
            if($selected_difficulty !=0 && $selected_ingredient > 0){
              ...
              while($row_recipes_with_ingredient = mysqli_fetch_assoc($recipes_with_ingredient_querry)){
                ...
                $find_recipe_with_id_sql = "SELECT * FROM recipes WHERE recipe_id = $recipe_id and difficulty = $selected_difficulty and category = 'Γλυκό'";
            ...
            elseif($selected_ingredient > 0){
              ...
              while($row_recipes_with_ingredient = mysqli_fetch_assoc($recipes_with_ingredient_querry)){
                ...
                //entolh pou tha vrei apo ton pinaka twn recipes afto me to id pou vrhkame apo panw
                $find_recipe_with_id_sql = "SELECT * FROM recipes WHERE recipe_id = $recipe_id and category = 'Γλυκό'";
            ...
            elseif($selected_difficulty != 0){
              ...
              $find_recipe_with_id_sql = "SELECT * FROM recipes WHERE difficulty = $selected_difficulty and category = 'Γλυκό'";
              ...
              //entolh..
              $find_recipe_with_id_sql = "SELECT * FROM recipes WHERE category = 'Γλυκό'";
