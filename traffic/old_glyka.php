    ...
    <a class="navbar-brand fs-2" href="index.php"><i class="fa-solid fa-burger"></i> Foodini</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link selected" href="faghta.php">Φαγητά</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container-fluid row py-3 rounded" style="background-color: #F7C566; ">
      ...
      <div class="col-8 py-5 px-0" style="background-color: #a5202000; ">
        ...
        <div class="container p-3 mx-0" style="background-color: #FFF8DC; border-radius: 1rem;">
          ...
          $sql = "SELECT * FROM recipes WHERE category = 'Γλυκό' ";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              while ($row3 = mysqli_fetch_assoc($result3)){
                ...
                if($selected_diff != 0){
                  ...
                  echo "<h2 class='m-2'>Syntages me ".$row3['title']." kai vathmo dyskolias: ".$selected_diff."</h2>";
              ...
              $sql2 = "SELECT * FROM recipes WHERE recipe_id = $bam and category = 'Γλυκό'";
              ...
              $sql2 = "SELECT * FROM recipes WHERE recipe_id = $bam and category = 'Γλυκό' and difficulty = $selected_diff";
              $result2 = mysqli_query($conn, $sql2);
              while ($row2 = mysqli_fetch_assoc($result2)){
                        echo "
                          <a href='" . $row2["page_title"] . ".php' style='text-decoration: none;'>
                ...
                $sql2 = "SELECT * FROM recipes WHERE category = 'Γλυκό' and difficulty = $selected_diff";
                $result2 = mysqli_query($conn, $sql2);
                          ...
                          if($selected_diff == 0){
                            ...
                            echo "<h2 class='m-2'>Syntages me vathmo dyskolias: ".$selected_diff."</h2>";
                            while ($row2 = mysqli_fetch_assoc($result2)) {
                              echo "
                                  <a href='" . $row2["page_title"] . ".php' style='text-decoration: none;'>
                                  <div class='card mb-3 m-3' >
